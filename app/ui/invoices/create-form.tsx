        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              Screen readers will read this description when the user interacts with the select box to notify them
              of errors. */
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                required // this will automatically display a warning message to enter a value if it's empty and the user tries to submit
